...
- **fluent-bit** - Log processor/forwarder  
- **node_exporter** - Prometheus system metrics exporter

## Development & Code Quality
- **lefthook** - Git hooks manager (faster than pre-commit)
...
- **skaffold** - Continuous deployment for Kubernetes
- **stern** - Multi-pod log tailing for Kubernetes
- **popeye** - Kubernetes cluster sanitizer

## Windows-Specific Power Tools
- **winget** - Official Windows package manager
- **PowerToys** - Microsoft's power user utilities
